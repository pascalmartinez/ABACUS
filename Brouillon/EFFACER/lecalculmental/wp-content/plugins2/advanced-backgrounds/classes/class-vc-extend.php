...
class NK_AWB_VC_Extend {
    ...
    public function admin_enqueue_scripts( $page ) {
        if ( 'post.php' === $page || 'post-new.php' === $page ) {
            wp_enqueue_media();
            wp_enqueue_style( 'nk-awb-vc-attach-file', nk_awb()->plugin_url . 'assets/admin/vc_extend/vc-awb-attach-video.min.css', '', '1.4.5' );
            wp_enqueue_style( 'nk-awb-vc-heading', nk_awb()->plugin_url . 'assets/admin/vc_extend/vc-awb-heading.min.css', '', '1.4.5' );
            wp_enqueue_style( 'nk-awb-vc-icon', nk_awb()->plugin_url . 'assets/admin/vc_extend/vc-awb-icon.min.css', '', '1.4.5' );
            wp_enqueue_script( 'nk-awb-vc-frontend', nk_awb()->plugin_url . 'assets/admin/vc_extend/vc-awb-frontend.min.js', array( 'jquery' ), '1.4.5' );
        }
    }
    ...
    public function vc_shortcode_extend_params( $element, $group_name ) {
        ...
        vc_add_param(
            $element, array(
                ...
                'heading'     => esc_html__( 'Volume', 'advanced-backgrounds' ),
                'description' => esc_html__( 'Volume from 0 to 100.', 'advanced-backgrounds' ),
                'group'       => $group_name,
                'value'       => '0',
                'edit_field_class' => 'vc_col-sm-6',
                'dependency' => array(
