<?php session_start();
if($_SESSION["connected"]!=1){header("Location:index.php");}
?>
...
<body>
	...
	<h3 class="btn nbr">Nombre ?</h3>
	<div class="result btn" style="opacity:0">0</div>
	<form id="dis" action="index.php" method="post"><label>Bonjour <?php echo $_SESSION["nom"];?></label><input type="hidden" name="deconnexion" value="1" /><input type="submit" value="deconnexion" /></form>
	<div class="boulier">
